...
class AppColors {
  static const primary = Color.fromARGB(255, 81, 171, 109);
  static const primaryback = Color(0xFFD7B7C9);
  ...
  static const violet = Color(0xff3b5998);
  ...
  static const grey229 = Color.fromARGB(255, 250, 250, 250);
